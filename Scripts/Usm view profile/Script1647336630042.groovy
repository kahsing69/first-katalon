...
WebUI.click(findTestObject('Object Repository/Page_SMU-Pelajar/a_Personal'))

WebUI.click(findTestObject('Object Repository/Page_SMU-Pelajar/a_Academic'))

WebUI.click(findTestObject('Object Repository/Page_SMU-Pelajar/a_Address  Beneficiary Name'))

WebUI.click(findTestObject('Object Repository/Page_SMU-Pelajar/a_Qualification'))
